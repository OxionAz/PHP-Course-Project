				...
				<!-- Main -->
					<section id="main">
						...
						<div class="exeption reg">
							<p class="error" id="exep_1">Введенный логин некорректен!</p>
							<p class="error" id="exep_2">Введенный пароль неверен!</p>
						</div>
						
						<form class="account" method="post">
							<input type="hidden" name="form" value="login" maxlength="0" />				
							<div class="field">								
								<input class="input" type="text" name="login" placeholder="Введите новый логин" maxlength="20" />
